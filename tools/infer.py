...
class InferenceEngine(object):
    ...
    def __init__(self, args):
        ...
        'args':{'thresh': 0.3, 'box_thresh': 0.7, 'max_candidates':1000, 'unclip_ratio': 1.5}})
    ...
    def postprocess(self, x, shape_info, is_output_polygon):
        ...
        """
        box_list, score_list = self.post_process(shape_info, x, is_output_polygon=is_output_polygon)
...
def main(args):
    ...
    # postprocess
    box_list, score_list = inference_engine.postprocess(output, shape_info, args.polygon)
    ...
    save_result(output_path.replace('_infer_result.jpg', '.txt'), box_list, score_list, args.polygon)
